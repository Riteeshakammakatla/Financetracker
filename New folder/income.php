...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] == 'delete') {
    $id = intval($_POST['id']);
    $conn->query("DELETE FROM incomes WHERE id = $id");
...
// Fetch all incomes
$incomes = [];
$res = $conn->query("SELECT * FROM incomes ORDER BY date DESC");
...
$sources = [];
$res = $conn->query("SELECT DISTINCT source FROM incomes ORDER BY source");
...
$months = [];
$res = $conn->query("SELECT DISTINCT DATE_FORMAT(date, '%Y-%m') as month_year FROM incomes ORDER BY month_year DESC");
