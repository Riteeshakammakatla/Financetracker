...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] == 'add') {
    ...
    $conn->query("INSERT INTO savings_goals (goal_name, target_amount, current_amount, created_date) VALUES ('$goalName', $targetAmount, $currentAmount, NOW())");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] == 'update') {
    ...
    $conn->query("UPDATE savings_goals SET current_amount = $currentAmount WHERE id = $id");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] == 'delete') {
    $id = intval($_POST['id']);
    $conn->query("DELETE FROM savings_goals WHERE id = $id");
    echo json_encode(['success' => true]);
    exit;
}
...
$goals = [];
$res = $conn->query("SELECT * FROM savings_goals ORDER BY created_date DESC");
