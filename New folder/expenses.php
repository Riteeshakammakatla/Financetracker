...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] == 'add') {
    ...
    $conn->query("INSERT INTO expenses (category, amount, date, note) VALUES ('$category', $amount, '$date', '$note')");
...
$categories = [];
$res = $conn->query("SELECT DISTINCT category FROM expenses ORDER BY category");
...
$months = [];
$res = $conn->query("SELECT DISTINCT DATE_FORMAT(date, '%Y-%m') as month_year FROM expenses ORDER BY month_year DESC");
